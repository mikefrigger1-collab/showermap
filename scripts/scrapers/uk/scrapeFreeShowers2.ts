...
const COASTAL_SEARCH_LOCATIONS = [
  // Yorkshire Coast
  { name: 'Scarborough', region: 'yorkshire', regionName: 'Yorkshire and the Humber' },
  { name: 'Whitby', region: 'yorkshire', regionName: 'Yorkshire and the Humber' },
  { name: 'Bridlington', region: 'yorkshire', regionName: 'Yorkshire and the Humber' },
  { name: 'Filey', region: 'yorkshire', regionName: 'Yorkshire and the Humber' },

  // North East Coast
  { name: 'Tynemouth', region: 'north-east', regionName: 'North East' },
  { name: 'South Shields', region: 'north-east', regionName: 'North East' },
  { name: 'Whitley Bay', region: 'north-east', regionName: 'North East' },
  { name: 'Seaham', region: 'north-east', regionName: 'North East' },

  // North West Coast
  { name: 'Blackpool', region: 'north-west', regionName: 'North West' },
  { name: 'Southport', region: 'north-west', regionName: 'North West' },
  { name: 'Morecambe', region: 'north-west', regionName: 'North West' },
  { name: 'Formby', region: 'north-west', regionName: 'North West' },

  // Wales Coast
  { name: 'Tenby', region: 'wales', regionName: 'Wales' },
  { name: 'Pembrokeshire', region: 'wales', regionName: 'Wales' },
  { name: 'Porthcawl', region: 'wales', regionName: 'Wales' },
  { name: 'Barry Island', region: 'wales', regionName: 'Wales' },
  { name: 'Rhyl', region: 'wales', regionName: 'Wales' },
  { name: 'Llandudno', region: 'wales', regionName: 'Wales' },
  { name: 'Abersoch', region: 'wales', regionName: 'Wales' },
  { name: 'Aberystwyth', region: 'wales', regionName: 'Wales' },

  // Scotland Coast
  { name: 'Aberdeen Beach', region: 'scotland', regionName: 'Scotland' },
  { name: 'St Andrews', region: 'scotland', regionName: 'Scotland' },
  { name: 'Portobello Edinburgh', region: 'scotland', regionName: 'Scotland' },
  { name: 'North Berwick', region: 'scotland', regionName: 'Scotland' },
  { name: 'Dundee Beach', region: 'scotland', regionName: 'Scotland' },
  { name: 'Ayr', region: 'scotland', regionName: 'Scotland' },
  { name: 'Troon', region: 'scotland', regionName: 'Scotland' },

  // Northern Ireland Coast
  { name: 'Portrush', region: 'northern-ireland', regionName: 'Northern Ireland' },
  { name: 'Portstewart', region: 'northern-ireland', regionName: 'Northern Ireland' },
  { name: 'Newcastle Co Down', region: 'northern-ireland', regionName: 'Northern Ireland' },
  { name: 'Bangor Northern Ireland', region: 'northern-ireland', regionName: 'Northern Ireland' },
];
