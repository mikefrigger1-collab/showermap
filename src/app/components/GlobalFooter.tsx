        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/map/" className="text-gray-300 hover:text-primary-400 transition-colors">Find Showers</Link></li>
              <li><Link href="/about/" className="text-gray-300 hover:text-primary-400 transition-colors">About Us</Link></li>
              <li><Link href="/guidelines/" className="text-gray-300 hover:text-primary-400 transition-colors">Usage Guidelines</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/usa/" className="text-gray-300 hover:text-primary-400 transition-colors">United States</Link></li>
              <li><Link href="/canada/" className="text-gray-300 hover:text-primary-400 transition-colors">Canada</Link></li>
              <li><Link href="/uk/" className="text-gray-300 hover:text-primary-400 transition-colors">United Kingdom</Link></li>
              <li><Link href="/australia/" className="text-gray-300 hover:text-primary-400 transition-colors">Australia</Link></li>
            </ul>
          </div>
        </div>
