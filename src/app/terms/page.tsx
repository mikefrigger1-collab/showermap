        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <p className="mb-3">When using ShowerMap, you agree to:</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">4. User-Generated Content</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Disclaimers and Limitations</h2>
              <p className="mb-3">
